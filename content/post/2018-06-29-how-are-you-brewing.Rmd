...
The dataset comes from kaggle in CSV format, so let's import it and see what we've got.[^2]
...
[^2]: I have to confess to cheating ever so slightly here. A few of the beer style names had foreign characters (umlauts etc.) in them, so I edited these names in the CSV because I still haven't figured out encoding in R!
